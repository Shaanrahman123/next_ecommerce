...
export default function SimilarProducts({ currentProductId, products }: SimilarProductsProps) {
  ...
  return (
    <div className="bg-white rounded-xl md:rounded-2xl border border-amber-100 p-4 md:p-6 lg:p-8">
