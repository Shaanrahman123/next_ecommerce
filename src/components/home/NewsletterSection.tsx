                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-12">
                    ...
                    <div className="text-white space-y-3 md:space-y-6">
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <h2 className="text-section-title font-black uppercase">
                                JOIN THE CLUB
                            </h2>
                        </div>
                        <p className="text-body font-medium opacity-90 leading-tight">
                        ...
                        <div className="flex items-start gap-2 md:gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-card-title mb-0.5">Get ₹500 OFF</h3>
                                <p className="text-[12px] md:text-base opacity-90">On your first purchase above ₹2,999</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="w-full">
                            {subscribed ? (
                                <div className="bg-white rounded-xl p-4 md:p-8 text-center animate-scale-in">
                                    ...
                                    <h3 className="text-card-title font-bold text-gray-900 mb-1">
                                        You're In! 🎉
                                    </h3>
                                ...
                                <form onSubmit={handleSubscribe} className="space-y-2 md:space-y-4">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-2 md:px-6 md:py-4 rounded-full text-gray-900 text-[12px] md:text-base font-medium focus:outline-none focus:ring-2 focus:ring-white/50 transition-all"
                                            required
                                        />
                                    </div>
                                    <Button
                                        ...
                                        fullWidth
                                        size="lg"
                                        className="bg-white text-gray-900 hover:bg-gray-100 font-bold rounded-full shadow-lg text-[12px] md:text-base h-10 md:h-auto"
                                    >
                                        Subscribe Now
                                    </Button>
                                    <p className="text-white/80 text-[9px] md:text-sm text-center">
